...
def evaluate_ood(
    ...
    auroc_entropy = roc_auc_score(all_labels, -all_entropy) * 100.0
    ...
    fpr95_msp = compute_fpr_at_tpr(all_msp, all_labels, 0.95)
    fpr95_entropy = compute_fpr_at_tpr(-all_entropy, all_labels, 0.95)
